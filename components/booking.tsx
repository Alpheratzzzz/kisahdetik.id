    ...
    >
      <div className="grid gap-8 rounded-4xl border border-[#C9A227]/20 bg-[#161616] p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-12">
        <div className="space-y-6">
          <p className="text-sm uppercase tracking-[0.35em] text-[#C9A227]">
            Booking
          </p>
          ...
          <p className="max-w-xl text-base leading-8 text-[#F5F5F5]/75">
            Mari diskusikan konsep visual untuk acara Anda. Kami siap membantu
            dari tahap konsultasi hingga pengiriman hasil akhir.
          </p>
        ...
        <form
          ...
          className="space-y-4 rounded-[28px] border border-white/10 bg-[#0A0A0A] p-6"
        >
